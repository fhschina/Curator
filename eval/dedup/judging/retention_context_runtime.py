...
from eval.dedup.judging import retention_context_v1 as adapter
...
VERSION = "v0.6.2.33-exp3"
CONFIG = Path(__file__).resolve().parents[1] / "resources/local_ndd/hs_v06233_exp3.yaml"
...
def specification(version: str = VERSION) -> dict:
    ...
    paths = {
        ...
        str(Path(__file__).with_name("retention_v4.py")),
        str(Path(__file__).with_name("retention_v4_proof.py")),
    }
