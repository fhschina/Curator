...
"""Semantic-only V3 judge output schema."""
...
from eval.dedup.judging.schema_v2 import (
    ...
    PRIMARY_MATERIAL_DIFFERENCES,
    PRIMARY_RISK_FACTORS,
)
from eval.dedup.validation import require

JUDGE_SCHEMA_V3: Final = "dedup-judge-output-v3"
...
def judge_output_schema_v3() -> dict[str, Any]:
    return {
...
def validate_judge_output_v3(value: Any) -> dict[str, Any]:
...
def unresolved_judge_output_v3() -> dict[str, Any]:
    return {
