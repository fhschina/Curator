...
"""Opt-in Exp5 composition with deterministic shared-anchor zero-padding only."""
...
VERSION = "v0.6.2.33-exp5+anchor-id-fix1"
old = previous.old


def execute_case(root: Path, row: dict, endpoint: str, frozen: dict, render_coverage: Callable) -> dict:
    """Keep the frozen Exp5 source intact so its historical receipts remain replayable."""
