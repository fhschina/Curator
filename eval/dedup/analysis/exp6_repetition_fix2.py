...
"""Opt-in Exp6 plus one format-only recovery for truncated repetitive main output."""
...
from eval.dedup.judging import critic_anchor_ids
...
VERSION = "v0.6.2.33-exp6+main-repetition-fix2"
old = previous.old
