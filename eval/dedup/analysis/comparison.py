...
from eval.dedup.core.contracts import DuplicateAnswer, Track
        ...
        output.append(
            {
                **pair,
                ...
                "fuzzy_scope": result.get("fuzzy_scope") if result else None,
                "primary_material_difference": result.get("primary_material_difference") if result else None,
                "expected_minhash_action": result.get("expected_minhash_action") if result else None,
                "surface_evidence_sufficiency": result.get("surface_evidence_sufficiency") if result else None,
                "expected_minhash_outcome": result.get("expected_minhash_outcome") if result else None,
                "dominant_overlap_source": result.get("dominant_overlap_source") if result else None,
                "primary_risk_factor": result.get("primary_risk_factor") if result else None,
                "evidence_quality": result.get("evidence_quality") if result else None,
